...
class Mascota(db.Model):
	...
	localidad = db.Column(db.Unicode(120))
...
def insertarDatosIniciales():
	try:
		...
		# USUARIOS
		usuario_auxiliar = Usuario(username='admin', nombre="Administrador", apellido="Patitas", email='admin@patitas.com', password='admin', rol_id = 1, celular='09999999', telefono='22220000', fecha_registro= datetime.datetime.now(), confirmado=True, fecha_confirmado= datetime.datetime.now())
		db.session.add(usuario_auxiliar)
		usuario_auxiliar = Usuario(username='comun', nombre="Usuario", apellido="Patitas", email='comun@patitas.com', password='comun', rol_id = 2, celular='09999999', telefono='22220000', fecha_registro= datetime.datetime.now(), confirmado=True, fecha_confirmado= datetime.datetime.now())
		db.session.add(usuario_auxiliar)
